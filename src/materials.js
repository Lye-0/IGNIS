...
const MATERIALS = Object.freeze({
  paper: {id:0, label:'くしゃくしゃの紙', short:'くしゃ紙', english:'CRUMPLED PAPER', note:'ふわりと舞い、薄い灰へ。', mass:.028, radius:.19, ignition:.75, burn:24, ember:15, power:.80, smoke:.12, sparks:7, drag:.32, restitution:.19, color:[.71,.65,.53]},
  cardboard: {id:1, label:'段ボール片', short:'段ボール', english:'CORRUGATED CARD', note:'縁から焦げて、反り返る。', mass:.055, radius:.27, ignition:1.5, burn:40, ember:22, power:.64, smoke:.17, sparks:10, drag:.21, restitution:.13, color:[.35,.19,.078]},
  twig: {id:2, label:'乾いた小枝', short:'小枝', english:'DRY TWIG', note:'細い枝先から、赤い熾火に。', mass:.115, radius:.37, ignition:2.5, burn:58, ember:36, power:.53, smoke:.08, sparks:17, drag:.05, restitution:.25, color:[.18,.095,.038]},
  wood: {id:3, label:'割った木片', short:'木片', english:'SPLIT WOOD', note:'ゆっくり着火し、長く熱を残す。', mass:.30, radius:.34, ignition:3.8, burn:95, ember:55, power:.48, smoke:.11, sparks:23, drag:.025, restitution:.16, color:[.46,.27,.115]}
});
